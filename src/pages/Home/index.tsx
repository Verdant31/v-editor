        ...
        >
          ...
          <div className="flex flex-col mt-6 gap-6">
            <button onClick={() => navigate("/project")} className="h-14 bg-[#8257e5] rounded-md w-80 hover:scale-105 transition-all duration-300">
              <p className="tracking-wider text-lg">React</p>
            </button>
            <button onClick={() => navigate("/singleFile")} className="h-14 bg-[#8257e5] rounded-md w-80 hover:scale-105 transition-all duration-300">
              <p className="tracking-wider text-lg">Javascript</p>
            </button>
          </div>
        </motion.div>
      )}
